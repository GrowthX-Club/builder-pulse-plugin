...
set "BUILDER_PULSE_PLUGIN_VERSION=0.6.0"
if defined BUILDER_PULSE_RUNTIME_DIR (set "BP_RUNTIME=%BUILDER_PULSE_RUNTIME_DIR%") else (set "BP_RUNTIME=%USERPROFILE%\.builder-pulse\runtime\0.6.0")
